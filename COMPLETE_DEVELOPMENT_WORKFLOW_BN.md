...
## **Backend সম্পন্ন:**
- [x] Django প্রজেক্ট সেটআপ
- [x] PostgreSQL ডাটাবেস সংযোগ
- [x] ডাটা মডেল তৈরি
- [x] ব্যবহারকারী অথেনটিকেশন
- [x] ইমেইল ভেরিফিকেশন
- [x] SendGrid ইন্টিগ্রেশন
- [x] অটো ডেটা জেনারেশন
- [x] API এন্ডপয়েন্ট

## **Frontend সম্পন্ন:**
- [x] HTML টেমপ্লেট
- [x] CSS স্টাইলিং (Bootstrap)
- [x] রেজিস্ট্রেশন পেজ
- [x] লগইন পেজ
- [x] ড্যাশবোর্ড পেজ
- [x] ইনবক্স পেজ
...
## **ফিচার সম্পন্ন:**
- [x] প্রতিষ্ঠান ম্যানেজমেন্ট
- [x] শিক্ষার্থী ম্যানেজমেন্ট
- [x] ইমেইল অ্যাকাউন্ট জেনারেশন
- [x] ইমেইল ইনবক্স সিস্টেম
